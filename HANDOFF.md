...
- **Next audit slice:** continue trace production lifecycle auditing at frontend and desktop consumers of gateway trace links (`frontend/components/Chat/*`, stream/offline queue UI or IPC consumers, and any Trace Explorer assumptions about failed-run rows).
