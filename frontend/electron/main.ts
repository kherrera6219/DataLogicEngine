...
ipcMain.handle('run-local-ingestion', async (event, payload?: unknown, ...args: unknown[]) => {
  ...
  const requestPayload = {
    ...
    max_total_bytes: optionalBoundedInteger(
      parsedPayload,
      'max_total_bytes',
      'run-local-ingestion',
      100 * 1024 * 1024,
    ...
    max_files: optionalBoundedInteger(
      parsedPayload,
      'max_files',
      'run-local-ingestion',
      1000,
    ...
    max_pages: optionalBoundedInteger(
      parsedPayload,
      'max_pages',
      'run-local-ingestion',
      500,
    ...
    max_archive_entries: optionalBoundedInteger(
      parsedPayload,
      'max_archive_entries',
      'run-local-ingestion',
      10_000,
    ...
    max_decompressed_bytes: optionalBoundedInteger(
      parsedPayload,
      'max_decompressed_bytes',
      'run-local-ingestion',
      100 * 1024 * 1024,
    ...
    max_archive_depth: optionalBoundedInteger(
      parsedPayload,
      'max_archive_depth',
      'run-local-ingestion',
      1,
    ...
    parser_timeout_seconds: optionalBoundedInteger(
      parsedPayload,
      'parser_timeout_seconds',
      'run-local-ingestion',
      60,
