...
import { MessageSquarePlus, Activity, Database, ShieldCheck, AlertTriangle, TrendingUp } from 'lucide-react';
...
function StatCard({ title, value, subtext, icon: Icon, trend, variant = "default" }: StatCardProps) {
  return (
    <Card 
...
export default function DashboardPage() {
  ...
  const { data: summary } = useSWR('analytics-summary', () => api.analytics.summary(), {
  ...
  return (
    <PageLayout
      ...
      description="Enterprise Control Hub • 17-Axis Unified Standard"
      actions={
        <>
          <Link href="/chat">
            <Button 
