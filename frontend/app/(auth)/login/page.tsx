...
import { Loader2, Shield, Lock, User as UserIcon, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md glass-card border-white/10 shadow-2xl relative z-10 animate-in fade-in zoom-in duration-500">
        <CardHeader className="text-center pb-8 border-b border-white/5 mx-6">
            ...
            <CardDescription className="text-gray-300 font-medium">Sign in to DataLogicEngine</CardDescription>
        </CardHeader>
        <CardContent className="pt-8">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                    <Label htmlFor="username" className="text-xs font-bold uppercase tracking-widest text-gray-300">Username or Email</Label>
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="password" className="text-xs font-bold uppercase tracking-widest text-gray-300">Password</Label>
                    ...
                    <div className="relative">
                       ...
                       <Input
                          ...
                          placeholder="••••••••"
                          className="bg-white/5 border-white/10 h-11 pl-10 pr-11 rounded-xl focus-visible:ring-blue-500"
                          value={password}
        ...
        <CardFooter className="justify-center border-t border-white/5 mt-4 pt-6">
            <p className="text-sm text-gray-300 font-medium">
                Need access? <Link href="/register" className="text-blue-500 hover:underline">Request an account</Link>
            </p>
        </CardFooter>
      </Card>
