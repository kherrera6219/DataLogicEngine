...
export default function ProfilePage() {
  return (
    <main className="min-h-screen bg-black p-6 md:p-8 relative">
       <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_10%,_rgba(37,99,235,0.05),transparent_40%)]" />
       
       <div className="container mx-auto max-w-5xl relative z-10">
          <header className="mb-8">
             <Breadcrumbs items={[{ label: "User Management" }, { label: "Profile" }]} className="mb-4" />
             <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Authenticated Identity</h1>
             <p className="text-muted-foreground font-medium">Enterprise profile and security credentials.</p>
          </header>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="lg:col-span-1 glass-card border-white/10 shadow-2xl" role="region" aria-label="Identity Overview">
               <CardHeader className="flex flex-col items-center text-center">
                  ...
                  <CardTitle className="text-2xl font-bold tracking-tight mt-4 text-white">John Doe</CardTitle>
               ...
               <CardContent className="space-y-6 pt-6 border-t border-white/5">
                  <div className="space-y-1">
                     ...
                     <div className="text-sm font-semibold text-white">john.doe@example.com</div>
                  </div>
                  <div className="space-y-1">
                     <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                        <Briefcase className="h-3 w-3" aria-hidden="true" /> Department
                     </div>
                     <div className="text-sm font-semibold text-white">System Operations</div>
                  </div>
                  <div className="space-y-1">
                     <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                        <Calendar className="h-3 w-3" aria-hidden="true" /> Identity Provisioned
                     </div>
                     <div className="text-sm font-semibold text-white">Jan 10, 2024</div>
                  </div>
               </CardContent>
            </Card>
               ...
               <CardContent className="pt-8">
                  <form className="space-y-8">
                     ...
                     <div className="pt-6 border-t border-white/5 flex justify-end gap-3">
                        <Button variant="ghost" className="h-11 px-8 rounded-xl font-bold hover:bg-white/5 text-muted-foreground hover:text-white transition-all">Cancel</Button>
                        <Button className="h-11 px-8 rounded-xl bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/20 font-bold transition-all">Commit Changes</Button>
                     </div>
                  </form>
               </CardContent>
            </Card>
