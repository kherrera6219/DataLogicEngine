        ...
        <div className={cn(
          ...
          {!isThinking && !isUser && !isSystem && (
            <div className="absolute -right-12 top-0 opacity-0 group-hover:opacity-100 transition-opacity">
              <CopyButton text={message.content} className="h-8 w-8 rounded-lg bg-slate-200/80 dark:bg-gray-800/50 border border-slate-300/70 dark:border-white/10" />
            </div>
          )}
          ...
          {isThinking && (
            <div className="mt-4 pt-4 border-t border-white/5 space-y-3">
              ...
              <p className="text-[10px] text-slate-500 dark:text-gray-500 font-medium">Processing across 17 vectors of truth...</p>
            </div>
          )}
