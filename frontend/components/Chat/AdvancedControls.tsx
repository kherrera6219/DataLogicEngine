...
export function AdvancedControls() {
  return (
    <Sheet>
      ...
      <SheetContent side="right" className="bg-gray-900 border-l border-white/10 text-white w-[400px]">
        <SheetHeader>
        ...
        <div className="py-6 space-y-8">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 rounded border border-white/10 bg-white/5">
                        <div>
                            ...
                            <div className="text-[10px] text-gray-400">99.5% confidence • &lt;15s latency</div>
                        </div>
                        <Badge className="bg-blue-600">Active</Badge>
                    </div>
                    <div className="pt-2">
                        <label className="text-xs text-gray-400 mb-2 block">Confidence Threshold</label>
             ...
             <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                    {['Context Loading', 'Multi-Perspective', 'Deep Research', 'Cross-Axis Valid', 'Neural Analysis', 'Compliance Check'].map(layer => (
                        <div key={layer} className="flex items-center gap-2 text-xs text-gray-300">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <Button variant="outline" size="sm" className="justify-start text-xs border-white/10 h-8">
                        <Globe className="mr-2 h-3 w-3 text-gray-500" /> US - California
                    </Button>
                    <Button variant="outline" size="sm" className="justify-start text-xs border-white/10 h-8">
                        <Calendar className="mr-2 h-3 w-3 text-gray-500" /> Current (2026)
                    </Button>
                    <Button variant="outline" size="sm" className="justify-start text-xs border-white/10 h-8">
                        <Lock className="mr-2 h-3 w-3 text-gray-500" /> SOC2 + HIPAA
                    </Button>
                    <Button variant="outline" size="sm" className="justify-start text-xs border-white/10 h-8">
                        <GitBranch className="mr-2 h-3 w-3 text-gray-500" /> Production
                    </Button>
                </div>
            </div>

            <div className="pt-4 border-t border-white/10 flex gap-2">
                <Button className="flex-1 bg-white text-black hover:bg-gray-200">Save Preset</Button>
                <Button variant="outline" className="border-white/10 text-gray-400">Reset</Button>
            </div>
