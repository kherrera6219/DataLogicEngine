...
def test_cp19g_manifest_owns_exactly_one_versioned_12_step_registry():
    ...
    if manifest.manifest_version == "2026.08.08-cp19k.20":
        assert enabled_count == 211
    elif manifest.manifest_version == "2026.08.08-cp19k.15":
        assert enabled_count == 194
    elif manifest.manifest_version == "2026.08.04-cp19k.7":
    ...
    if manifest.manifest_version == "2026.08.08-cp19k.20":
        assert dependency_edges == 119
    elif manifest.manifest_version == "2026.08.08-cp19k.15":
        assert dependency_edges == 123
    elif manifest.manifest_version == "2026.08.04-cp19k.7":
    ...
    elif manifest.manifest_version == "2026.08.01-cp19k.1":
        assert dependency_edges == 135
    else:
