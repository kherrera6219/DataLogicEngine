...
approval, a complete notice bundle, or a SLSA conformance claim. Product 4.4.0
...
| Product/contracts | `config/product-versions.json` | Product 4.4.0, Windows 4.4.0.0, versioned public/gateway/governed/data contracts | Must match installer, binaries, UI/API/support, SDKs, manifests, and evidence |
