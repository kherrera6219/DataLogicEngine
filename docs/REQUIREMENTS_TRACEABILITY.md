...
| DLE-FR-011 | Phase 18 canonical KA manifest/crosswalk, typed controller/selector, authoritative service ports, API/SDK/desktop workflow, and causal execution records | One named functional test per KA, manifest/call-path/selector gates, effect receipts, integration/security/performance/trace/replay suites, and Phase 18 evidence | Partial: CP18-A 213-capability no-duplicate authority passed; CP18-B active, CP18-C through CP18-H retained, and rebuild paused |
