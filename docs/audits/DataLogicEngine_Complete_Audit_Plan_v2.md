...
| **A32** | scripts | ⏭ NEXT | — | retire/refresh one-off `audit_deep.py` + `audit_duplicates.py` (superseded by `find_orphaned_modules.py` + `find_core_backend_inversions.py`); `seed_data.py` guard check; stale-file sweep |
...
**Phases 1, 2 & 3 COMPLETE. Phase 4 in progress — A18–A31 done; A32 (scripts) is the last area.**
