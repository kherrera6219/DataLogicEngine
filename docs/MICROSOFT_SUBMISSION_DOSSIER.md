...
| Version managed by installer for Win32 route | Product authority is 4.4.3/4.4.3.0 | Installer/file/UI/API version parity and upgrade ordering |
...
basis. No WACK run has been performed for the signed 4.4.3 release candidate.
