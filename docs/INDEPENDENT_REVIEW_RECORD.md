...
signed DataLogicEngine 4.4.2 release candidate. This record is `not_evaluated`.
...
|---|---|---|
| Product/version | DataLogicEngine Desktop 4.4.2 / Windows 4.4.2.0 | Engineering target only |
