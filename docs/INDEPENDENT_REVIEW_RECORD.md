...
signed DataLogicEngine 4.4.3 release candidate. This record is `not_evaluated`.
...
|---|---|---|
| Product/version | DataLogicEngine Desktop 4.4.3 / Windows 4.4.3.0 | Engineering target only |
