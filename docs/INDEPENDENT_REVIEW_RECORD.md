...
signed DataLogicEngine 4.4.4 release candidate. This record is `not_evaluated`.
...
|---|---|---|
| Product/version | DataLogicEngine Desktop 4.4.4 / Windows 4.4.4.0 | Engineering target only |
