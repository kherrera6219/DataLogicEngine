...
def seed_nodes():
    ...
    nodes_data = [
        ...
        {"node_type": "axis", "label": "Axis 14: Acquisition Lifecycle", "axis_number": 14, "description": "AL1-AL7 acquisition stage routing"},
        {"node_type": "axis", "label": "Axis 15: Risk & Threat Context", "axis_number": 15, "description": "Six-dimensional risk decomposition"},
        {"node_type": "axis", "label": "Axis 16: Ethics, Trust & Criticality", "axis_number": 16, "description": "Sensitivity and ethics framework routing"},
        {"node_type": "axis", "label": "Axis 17: FROST-Mode Selector", "axis_number": 17, "description": "Tier to FROST depth and TruthCore mode bridge"},
