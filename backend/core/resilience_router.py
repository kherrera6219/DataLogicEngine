...
This module provides a robust wrapper for Knowledge Algorithm execution.
It implements the 'Graceful Degradation' pattern:
...
class ResilienceRouter:
    """
    Manages execution reliability and fallback logic.
    """
...
# Singleton
_resilience_router = None

def get_resilience_router(audit_logger=None):
