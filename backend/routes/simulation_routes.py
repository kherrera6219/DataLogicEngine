...
def get_simulations():
    ...
    try:
        ...
        simulations = SimulationSession.query.filter_by(user_id=user.id).all()
...
def get_simulation(simulation_id):
    ...
    user = _get_authenticated_user()
    simulation = SimulationSession.query.filter_by(session_id=simulation_id, user_id=user.id).first()
