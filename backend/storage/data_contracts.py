...
LOGICAL_DATA_CONTRACTS: tuple[LogicalDataContract, ...] = (
    ...
    _contract(
        ...
        StoreAuthority.POSTGRESQL,
        "ingestion_jobs.id/ingestion_files.id/ingestion_chunks.id",
        materializations=(
            StoreAuthority.REDIS,
        ...
        compensation="retain_checkpoint_and_resume_only_from_committed_authority",
        retention="ingested_content",
    ),
    _contract(
    ...
    _contract(
        ...
        materializations=(StoreAuthority.POSTGRESQL,),
        status="versioned_session_working_memory_not_trusted_knowledge_authority",
        transaction="atomic_file_replace",
        compensation="retain_previous_file_and_rebuild_from_last_valid_revision",
        retention="bounded_session_working_memory",
        notes="Validated run truth remains PostgreSQL audit/trace authority; this JSON graph cannot authorize trusted recall across sessions.",
    ),
    _contract(
    ...
    _contract(
        "simulation_execution_state",
        StoreAuthority.POSTGRESQL,
        "simulation_sessions.session_id/simulation_steps.id",
        materializations=(
            StoreAuthority.REDIS,
            StoreAuthority.NEO4J,
            StoreAuthority.CHROMA,
        ...
        compensation="resume_only_from_verified_checkpoint_and_remaining_budget",
