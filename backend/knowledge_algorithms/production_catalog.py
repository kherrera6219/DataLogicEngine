...
_PRODUCTION_VALIDATORS = {
    "KA-004", "KA-009", "KA-024", "KA-061", "KA-074", "KA-117",
    "L10-KA-003", "L10-KA-005", "L10-KA-006",
}
_PRODUCTION_HEURISTICS = {"KA-001", "KA-113"}
_EXPERIMENTAL = {
    "KA-002", "KA-006", "KA-007", "KA-008", "KA-012", "KA-013",
    "KA-020", "KA-021", "KA-028", "KA-029", "KA-032", "KA-034",
    "KA-035", "KA-038", "KA-040", "KA-041", "KA-042", "KA-043",
    "KA-051", "KA-054", "KA-055", "KA-057", "KA-058", "KA-059",
    "KA-063", "KA-066", "KA-067", "KA-068", "KA-069", "KA-070",
    "KA-081", "KA-082", "KA-083", "KA-085", "KA-086", "KA-088",
    "KA-089", "KA-090", "KA-100", "KA-Master",
}
_PRESENTATION_HELPERS = {
    "KA-056", "KA-091", "KA-092", "KA-093", "KA-094", "KA-095",
}
...
def load_production_catalog(
    ...
    path = Path(registry_path) if registry_path else Path(__file__).with_name("ka_registry.yaml")
    registry = (yaml.safe_load(path.read_text(encoding="utf-8")) or {}).get("ka_registry", {})
    return {
