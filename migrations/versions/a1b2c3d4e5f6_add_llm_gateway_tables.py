...
def upgrade():
    ...
    if not _table_exists(inspector, "llm_provider_usage"):
        op.create_table(
            ...
            sa.Column("api_key_id", sa.String(36), sa.ForeignKey("external_api_keys.id"), nullable=True),
    ...
    if not _table_exists(inspector, "external_api_keys"):
        op.create_table(
            ...
            sa.Column("allowed_providers", json_type, nullable=True),
            sa.Column("allowed_models", json_type, nullable=True),
