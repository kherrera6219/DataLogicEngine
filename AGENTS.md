...
Current version 4.4.1, status `release_blocked`. Market: **United States only** — the product is not placed on the EU market, so EU CRA / EU AI Act / GDPR / NIS2 / DORA are out of scope.
