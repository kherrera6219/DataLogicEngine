...
class AxisSystem:
    ...
    def _initialize_axes(self):
        ...
        logger.info("Initialized Axis 1: Knowledge (Pillar Levels 1-100)")
        ...
        # Knowledge Expert
        self.axes[8] = PersonaSystem(expert_type="knowledge")
        logger.info("Initialized Axis 8: Knowledge Expert")

        # Skill Expert
        self.axes[9] = PersonaSystem(expert_type="skill")
        logger.info("Initialized Axis 9: Skill Expert")

        # Role Expert
        self.axes[10] = PersonaSystem(expert_type="role")
        logger.info("Initialized Axis 10: Role Expert")

        # Context Expert
        self.axes[11] = PersonaSystem(expert_type="context")
