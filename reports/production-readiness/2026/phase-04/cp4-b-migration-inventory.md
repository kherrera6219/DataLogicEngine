...
- Captured: `2026-07-25T06:26:59.415207+00:00`
- Production migration ready: **No**
- Alembic revisions: **24**
- Alembic base/head: `000000000001` / `e0f1a2b3c4d5`
...
|---|---|---|---|---|---|---|
| postgresql | alembic:d9e0f1a2b3c4 | SELECT version_num FROM alembic_version | transactional Alembic upgrade through the single revision head | revision-specific downgrade only after verified coordinated backup | fresh_install_and_current_head_coordinated_restore_passed | supported_0_1_1_upgrade_not_qualified |
...
| minio | dle.minio.v1 | HEAD app-owned schema manifest object and verify metadata/hash | version object metadata, bucket policies, lifecycle, and retention contracts | restore portable bucket snapshot with key/metadata/hash parity | legacy_key_vendor_neutral_s3_manifest_restore_and_hash_parity_passed | supported_0_1_1_minio_adoption_not_qualified |
