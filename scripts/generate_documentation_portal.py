...
def render(
    ...
    *,
    ...
    ka_evidence = (
        ...
        "current 142-edge zero-cycle dependency graph. CP19-K batches 01-11 "
        "qualify 51 rows. Batch 09 retains the causal fail-closed secure-"
        ...
        "worker assignment, deployment, or model artifact. Batch 11 binds "
        "version, experiment, pruning, and quantization proposals plus measured "
        "health into one idempotent release-preparation record while applying "
        "no deployment, routing, registry, rollback, weight, artifact, or "
        "provider effect. The 186-row Batch "
        "07 baseline remains grouped into 36 dependency-safe batches; Batches "
        "08-11 are complete, 32 remain, and Batch 12 is knowledge temporal "
        "health. The generated matrix reports 51/213 qualified and 162 open. "
        "The 826-test KA suite, 227 governed/TruthCore/Phase-19/simulation "
        "integration tests, and the 2,716-test full source suite pass with 19 "
