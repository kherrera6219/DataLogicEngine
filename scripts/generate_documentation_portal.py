...
def render(
    ...
    *,
    ...
    ka_evidence = (
        ...
        "current 119-edge zero-cycle dependency graph. CP19-K batches 01-39 "
        "qualify 195 rows. Batches 35-39 complete bounded inference mapping, "
        ...
        "production boundaries. The 186-row Batch 07 "
        "baseline remains grouped into 36 dependency-safe batches; Batches "
        "08-39 are complete, four remain, and Batch 40 is the operations health "
        "and recovery group. The generated matrix reports 195/213 qualified and "
        "18 open. The 970-test KA suite, 378 governed/TruthCore/Phase-19/simulation "
        "integration tests, seven TypeScript SDK tests, and the 3,027-test full "
