...
def render(
    ...
    *,
    ...
    ka_evidence = (
        ...
        "owner per KA, 170 production-enabled capabilities, one runtime "
        "manifest, 213 positive and 213 negative selector fixtures, and a "
        "current 135-edge zero-cycle dependency graph. CP19-K batches 01-23 "
        "qualify 115 rows. Batches 19-23 complete the five-node Quad Persona "
        "foundation, evidence/confidence/entropy validation, adaptive DMRF "
        "routing, retrieval-store maintenance, and release-gated knowledge "
        "content evolution through their real owners. The 186-row Batch 07 "
        "baseline remains grouped into 36 dependency-safe batches; Batches "
        "08-23 are complete, 20 remain, and Batch 24 is the knowledge-lifecycle "
        "analytics group. The generated matrix reports 115/213 qualified and "
        "98 open. The 890-test KA suite, 355 governed/TruthCore/Phase-19/simulation "
        "integration tests, seven TypeScript SDK tests, and the 2,866-test full "
