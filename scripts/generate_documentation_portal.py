...
def render(
    ...
    *,
    ...
    ka_evidence = (
        ...
        "owner per KA, 155 production-enabled capabilities, one runtime "
        "manifest, 213 positive and 213 negative selector fixtures, and a "
        "current 142-edge zero-cycle dependency graph. CP19-K batches 01-18 "
        "qualify 86 rows. Batches 16-18 add explicit adversarial/privacy "
        "evaluation, exact-dependency knowledge trust and containment, bounded "
        "supplied-graph expansion, and promotion decisions without applying "
        "attack, graph, quarantine, containment, persistence, or promotion "
        "effects. The 186-row Batch 07 baseline remains grouped into 36 "
        "dependency-safe batches; Batches 08-18 are complete, 25 remain, and "
        "Batch 19 is the persona foundation group. The generated matrix reports "
        "86/213 qualified and 127 open. "
        "The 861-test KA suite, 317 governed/TruthCore/Phase-19/simulation "
        "integration tests, seven TypeScript SDK tests, and the 2,799-test full "
        "source suite pass with 18 skipped and 35 known warnings. "
