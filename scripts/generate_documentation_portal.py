...
def render(
    ...
    *,
    ...
    ka_evidence = (
        ...
        "owner per KA, 174 production-enabled capabilities, one runtime "
        "manifest, 213 positive and 213 negative selector fixtures, and a "
        "current 128-edge zero-cycle dependency graph. CP19-K batches 01-26 "
        "qualify 129 rows. Batches 24-26 complete knowledge-lifecycle analytics, "
        "L10 oversight, and TruthGate system-integrity decisions through their "
        "real owners. The 186-row Batch 07 "
        "baseline remains grouped into 36 dependency-safe batches; Batches "
        "08-26 are complete, 17 remain, and Batch 27 is the knowledge-release "
        "and long-horizon group. The generated matrix reports 129/213 qualified and "
        "84 open. The 904-test KA suite, 369 governed/TruthCore/Phase-19/simulation "
        "integration tests, seven TypeScript SDK tests, and the 2,894-test full "
